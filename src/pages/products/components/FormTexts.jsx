...
function FormTexts({form}) {
  ...
  return (
    <Row layout='vertical' >
      <Col span={24}>
        <Form.Item label="Ismi" name='name' rules={[{ required: true, message: 'maydon bosh' }]} >
          <Input />
        </Form.Item>
      </Col>
      <Col span={24}>
        <Form.Item label="Sarlavha" name='title' rules={[{ required: true, message: 'maydon bosh' }]} >
          <Input />
        </Form.Item>
      </Col>
      <Col span={24}>
      ...
      <Col span={24}>
        <Form.Item label="Turkum" name='category_id' rules={[{ required: true, message: 'maydon bosh' }]} >
      ...
      <Col span={24}>
        <Form.Item label="Brend" name='brand_id' rules={[{ required: true, message: 'maydon bosh' }]} >
      ...
      <Col span={24}>
        <Form.Item label='Info' name='desc' rules={[{ type: 'string', required: true, message: "Maydon bo'sh" }]}>
